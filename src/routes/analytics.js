...
export const Analytics = () => {
    ...
    return (
        ...
        <Header className="frame-navigation" >
            ...
            <Button onClick={() => dispatch({ type: 'SET_USER', payload: 'Joe'} )}>Change</Button>
        </Header>
        ...
        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
            ...
            Now with Context, BrowserRouter, a Reducer, and a cleanly packaged Provider/Consumer component. Analytics Page
        </div>
        </Content>
        </>
    )
